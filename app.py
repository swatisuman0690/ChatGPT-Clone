...
summarise_button = st.sidebar.button("Summarise your conversation", key="summarise")
# except AttributeError:
#     st.sidebar.write("You have no coversation with me.")
if summarise_button:
    summarise_placeholder = st.sidebar.write("Your conversation Summary:\n\n"+st.session_state['conversation'].memory.buffer)
...
with container:
    with st.form(key='my_form', clear_on_submit=True):
        user_input = st.text_area("Ask me questions here:", key='input', height=150)
